...
export default function ProfilePage() {
  ...
  return (
    <div className={styles.page}>
      ...
      {isComplete && (
        <div className={styles.success} style={{ marginBottom: "1.25rem" }}>
          ✅ Perfil listo para solicitar crédito.{" "}
          <Link to="/applicant/apply" style={{ color: "#4ade80", fontWeight: 600 }}>Solicitar ahora →</Link>
        </div>
      )}
      ...
      <form onSubmit={handleSave}>
        <div className={styles.card}>
          ...
          <div className={styles.grid2}>
            {[
              ...
              { name: "documentNumber",  label: "Número CI" },
        ...
        <div className={styles.card}>
          ...
          <div className={styles.infoRow}>
            ...
            <Link to="/applicant/upload-document" style={{ color: "#38bdf8", fontSize: "0.875rem" }}>
              Gestionar →
            </Link>
          </div>
        </div>
